...
class WxPayConfig extends AWS_MODEL
{
	public $wxpay_openid;
	public $wxpay_mchid;
	public $wxpay_key;
	public $wxpay_appsecret;/*
	...
	public function __construct(){
		...
		$this->wxpay_openid = get_setting('wxpay_openid');
		$this->wxpay_mchid = get_setting('wxpay_mchid');
		$this->wxpay_key = get_setting('wxpay_key');
		$this->wxpay_appsecret = get_setting('wxpay_appsecret');
	}
}
