...
class WxPayDataBase
{
	...
	**/
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=".$WxPayConfig->wxpay_key;
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
 ...
 *
 * 企业向用户付款输入对象
 * @author liangsongyuan
 *
 */
class WxPayToUser extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
