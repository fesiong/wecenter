...
( function() {
	...
	var bbcodeMap = { table:'table', td:'td', th:'th', tr:'tr', b: 'strong', u: 'u', i: 'em', color: 'span', size: 'span', quote: 'blockquote', code: 'pre', url: 'a', email: 'span', img: 'span', '*': 'li', list: 'ol', pre: 'pre', video: 'video'},
		convertMap = { table:'table', td:'td', th:'th', tr:'tr', strong: 'b', b: 'b', u: 'u', em: 'i', i: 'i', code: 'code', li: '*', pre: 'code' },
		tagnameMap = { table:'table', td:'td', th:'th', tr:'tr', strong: 'b', em: 'i', u: 'u', li: '*', ul: 'list', ol: 'list', code: 'code', a: 'link', img: 'img', blockquote: 'quote' },
